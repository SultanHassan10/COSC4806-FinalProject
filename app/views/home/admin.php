...
<div class="container" id="createMember" onload="populateProvince()">
    <form class="form-horizontal" action="../app/controllers/addMember.php" method="post">
        <div class="form-group">
            <label class="control-label col-sm-2" for="Client">Name:</label>
            <div class="col-sm-10">
                <input type="text" name="name" onblur="checkName(this.value)" class="form-control" id="client" placeholder="Client's Name">
        ...
        <div class="form-group">
            ...
            <div class="col-sm-10">
                <select name="gender" id="designation" class="form-control" onclick="populateManagers(this.value)">
